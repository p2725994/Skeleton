...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnCancel" runat="server" height="26" style="z-index: 1; position: absolute; left: 302px; bottom: 321px" Text="Cancel" />
        ...
        <p>
            <asp:Button ID="btnLogin" runat="server" height="26px" OnClick="btnLogin_Click" style="z-index: 1; left: 230px; position: absolute; bottom: 321px; right: 1357px" Text="Login" width="60px" />
        </p>
    </form>
</body>
</html>
