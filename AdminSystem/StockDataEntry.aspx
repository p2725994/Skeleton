...
<body>
    <form id="form1" runat="server">
        ...
        <p>
            &nbsp;</p>
        <asp:Button ID="btnOK" runat="server" OnClick="btnOK_Click" style="z-index: 1; left: 10px; top: 303px; position: absolute; height: 26px; right: 1124px;" Text="OK" width="59px" />
        <p>
