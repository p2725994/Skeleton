...
<body>
    <form id="form1" runat="server">
        ...
        <p>
            <asp:TextBox ID="txtCustomerLastname" runat="server" BorderColor="White" height="22px" style="z-index: 1; left: 201px; top: 140px; position: absolute" width="128px"></asp:TextBox>
        </p>
        <p>
        ...
        <asp:Button ID="btnOK" runat="server" OnClick="btnOK_Click" style="z-index: 1; left: 51px; top: 379px; position: absolute; width: 54px" Text="OK" />
        <p>
