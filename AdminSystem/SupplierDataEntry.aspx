...
<body style="height: 399px">
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblSupplierDeliveryDate" runat="server" style="z-index: 1; left: 12px; top: 222px; position: absolute; width: 100px;" Text="Delivery Date"></asp:Label>
        <p>
            &nbsp;</p>
        <p>
        ...
        <asp:CheckBox ID="chkSupplierFromUk" runat="server" style="z-index: 1; left: 15px; top: 368px; position: absolute" Text="SupplierFromUK" />
        <asp:Button ID="btnOK" runat="server"  style="z-index: 1; left: 10px; top: 505px; position: absolute" Text="OK" OnClick="btnOK_Click1" />
        <asp:TextBox ID="txtSupplierDeliveryDate" runat="server" style="z-index: 1; left: 170px; top: 231px; position: absolute; margin-bottom: 0px"></asp:TextBox>
        <p>
            ...
            <asp:TextBox ID="txtSupplierAddress" runat="server" style="z-index: 1; left: 153px; top: 290px; position: absolute"></asp:TextBox>
        </p>
        <asp:Label ID="lblError" runat="server" style="z-index: 1; left: 8px; top: 428px; position: absolute; height: 19px"></asp:Label>
        <asp:Button ID="btnFind" runat="server" OnClick="btnFind_Click" style="z-index: 1; left: 534px; top: 120px; position: absolute" Text="Find" />
