...
<body>
    <form id="form1" runat="server">
        <div>
                ...
                <asp:Button ID="btnEdit" runat="server" style="z-index: 1; left: 444px; position: absolute; bottom: 471px;" Text="Edit" OnClick="btnEdit_Click" height="26px" width="55px" />
        ...
        <asp:Button ID="btnDelete" runat="server" style="z-index: 1; left: 530px; position: absolute; bottom: 468px;" Text="Delete" OnClick="btnDelete_Click" />
    </form>
</body>
</html>
