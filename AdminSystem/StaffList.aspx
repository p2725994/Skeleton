...
<body>
    <form id="form1" runat="server">
        <div>
                ...
                <asp:Button ID="btnEdit" runat="server" style="z-index: 1; left: 430px; position: absolute; bottom: 344px;" Text="Edit" OnClick="btnEdit_Click" height="26px" width="55px" />
                ...
                <asp:Button ID="btnMenu" runat="server" OnClick="btnMenu_Click" style="z-index: 1; left: 368px; top: 264px; position: absolute" Text="Return to Main Menu" />
        </div>
        <asp:Button ID="btnDelete" runat="server" style="z-index: 1; left: 498px; position: absolute; bottom: 345px;" Text="Delete" OnClick="btnDelete_Click" />
    </form>
</body>
</html>
